...
class Parser {
  ...
  std::map<TokenType, int> BinopPrecedence = {
      {tok_equal, 2},       {tok_less, 10},          {tok_greater, 10},
      {tok_less_equal, 10}, {tok_greater_equal, 10}, {tok_equal_equal, 12},
      {tok_bang_equal, 12}, {tok_minus, 15},         {tok_plus, 20},
      {tok_star, 40},       {tok_slash, 50}};
